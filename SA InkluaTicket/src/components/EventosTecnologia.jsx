...
function EventosTecnologia() {
    ...
    const SelectEvent = async () => {
        try {
            const response = await fetch('http://localhost:3000/eventosTecnologia', {
                method: 'GET',
                headers: {
...
<ul aria-label='Card de evento tecnologia' className='container'>
...
export default EventosTecnologia
