...
function EventosEducacao() {
    ...
    const SelectEvent = async () => {
        try {
            const response = await fetch('http://localhost:3000/eventosEducacao', {
                method: 'GET',
                headers: {
...
<ul aria-label='Card de evento educação' className='container'>
...
export default EventosEducacao
